...
{
    public class RagDoclingPipelineProcessor : IRagDoclingPipelineProcessor
    {
        ...
        public RagDoclingPipelineProcessor(
        ...
        public async Task<RagPipelineRequest> ExecutePipelineAsync(IFormFile file, RagUiRequest uiRequest)
        {
            ...
            var extraction = new MarkDownDocling();
            var metadata = new FileMetaDataHandler();
            var normalization = new TextNormalizationDoclingHandler();
