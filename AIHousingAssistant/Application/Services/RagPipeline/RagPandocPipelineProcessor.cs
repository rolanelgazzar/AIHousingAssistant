...
using AIHousingAssistant.Application.Services.RagPipeline.Handlers.MarkupPandoc;

namespace AIHousingAssistant.Application.Services.RagPipeline
{
    public class RagPandocPipelineProcessor : IRagPandocPipelineProcessor
    {
        ...
        public RagPandocPipelineProcessor(
        ...
        public async Task<RagPipelineRequest> ExecutePipelineAsync(IFormFile file, RagUiRequest uiRequest)
        {
            ...
            var extraction = new MarkDownPandocHandler();
            var metadata = new FileMetaDataHandler();
            var normalization = new TextNormalizationPandocHandler();
